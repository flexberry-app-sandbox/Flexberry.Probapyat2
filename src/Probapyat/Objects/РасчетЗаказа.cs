...
namespace IIS.Probapyat
{
    ...
    public class РасчетЗаказа : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Probapyat.Номенклатура fНоменклатура;
        
        private IIS.Probapyat.Заказ fЗаказ;
        ...
        [PropertyStorage(new string[] {
                "Номенклатура"})]
        [NotNull()]
        public virtual IIS.Probapyat.Номенклатура Номенклатура
        {
            get
            {
                ...
                IIS.Probapyat.Номенклатура result = this.fНоменклатура;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Probapyat.Заказ.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Заказ"})]
        public virtual IIS.Probapyat.Заказ Заказ
        {
            get
            {
                ...
                IIS.Probapyat.Заказ result = this.fЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасчетЗаказаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетЗаказаE", typeof(IIS.Probapyat.РасчетЗаказа));
                }
            }
        }
    }
    ...
    public class DetailArrayOfРасчетЗаказа : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Probapyat.DetailArrayOfРасчетЗаказа members)

        // *** End programmer edit section *** (IIS.Probapyat.DetailArrayOfРасчетЗаказа members)
        ...
        /// </summary>
        public DetailArrayOfРасчетЗаказа(IIS.Probapyat.Заказ fЗаказ) : 
                base(typeof(РасчетЗаказа), ((ICSSoft.STORMNET.DataObject)(fЗаказ)))
        {
        }
        
        public IIS.Probapyat.РасчетЗаказа this[int index]
        {
            get
            {
                return ((IIS.Probapyat.РасчетЗаказа)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Probapyat.РасчетЗаказа dataobject)
        {
