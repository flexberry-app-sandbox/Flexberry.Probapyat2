...
namespace IIS.Probapyat
{
    ...
    public class Контрагент : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Probapyat.Лица fЛицо;
        ...
        public virtual IIS.Probapyat.Лица Лицо
        {
            get
            {
                ...
                IIS.Probapyat.Лица result = this.fЛицо;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КонтрагентE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтрагентE", typeof(IIS.Probapyat.Контрагент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КонтрагентL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтрагентL", typeof(IIS.Probapyat.Контрагент));
                }
            }
        }
    }
